...
class ZeroShotRewritePrompter:
    def __init__(self) -> None:    
        
        self.instruction = "Reformulate the current question into a de-contextualized rewrite under the multi-turn information-seeking dialog context. The output format is: \nRewrite: $Rewrite"
        self.stop_tokens = ['\n']
    ...
    def build_turn_prompt(self, context, current_turn):
        ...
        while not check_length(this_prompt, 4000):
            t = 1
...
class OneShotRewritePrompter:
    ...
    def build_turn_prompt(self, context, current_turn):
        ...
        while not check_length(this_prompt, 4000):
            t = 1
            all_prompts[t] = "Question: {}\nResponse: {}".format(context[t-1]['question'], "N/A")
            this_prompt = "\n\n".join(all_prompts)
            t += 1        
        this_prompt += "\n\n**Note that you should always try to rewrite it. Never ask for clarification or say you don't understand it in the generated rewrite.** Now, go ahead!"
        return this_prompt
...
class ZeroShotRewriteAndResponsePromptor:
    def __init__(self) -> None:    
        
        self.instruction = "Reformulate the current question into a de-contextualized rewrite under the multi-turn information-seeking dialog context and generate an appropriate response to the current question. The output format is: \nRewrite: $Rewrite\n\nResponse: $Response"
        self.stop_tokens = None
...
class OneShotRewriteAndResponsePromptor:
    def __init__(self) -> None:    
        
        self.instruction = "For an information-seeking dialog. Please help reformulate the questions into rewrites that can fully express the user's information needs without the need of context, but also generate an appropriate response to answer the question.\n\nI will give you an example multi-turn dialog, where each turn contains a question, a response, and a rewrite that you need to generate. \n\n# An Example Multi-turn Dialog:\n\nQuestion: What should I consider when buying a phone?\nRewrite: What should I consider when buying a phone?\nResponse: The design of the phone and the overall look and feel of the phone are very important. You should be comfortable with the way the phone looks and feels when you hold it in your hand. In addition, don't be afraid to get a phone from a different manufacturer than you're used to. Consider an older, used, or refurbished phone to save money. Sometimes a year-old or even a two-year-old device might give you everything you need.\n\nQuestion: Cool. Which one would you recommend?\nRewrite: Cool. Which smartphone would you recommend for me?\nResponse: If you want something more affordable, cheaper, but has the latest in Android and that comes with 5000mAh of battery, then the Motorola Moto G7 Power is an excellent phone to consider. If you want an Android smartphone that's cheaper, more affordable, and you still find the Moto G7 Power a bit off your budget, then I highly recommend the Samsung Galaxy A10e.\n\nQuestion: Tell me more about the first one.\nRewrite: Tell me more about the Motorola Moto G7 Power.\nResponse: It sports an 8-megapixel camera on the front for selfies with an f/2.2 aperture and a pixel size of 1.12-micron. Motorola Moto G7 Power is based on Android 9.0 and packs 32GB of inbuilt storage that can be expanded via a microSD card (up to 512GB). The Motorola Moto G7 Power is a dual-SIM (GSM and GSM) smartphone that accepts Nano-SIM and Nano-SIM cards. The Motorola Moto G7 Power measures 160.83 x 76.00 x 9.40mm (height x width x thickness) and weighs 198.00 grams.\n\nQuestion: How much cheaper is the A10e?\nRewrite: How much cheaper is the Samsung Galaxy A10e than the Motorola Moto G7 Power?\nResponse: The current lowest price found for Samsung Galaxy A10e is 7,499 and for Motorola Moto G7 is 13990. The details of both of these products were last updated on Jun 02, 2021.\n\nQuestion: Wow, that's almost half the cost! Can you compare them?\nRewrite: Wow, that's almost half the cost of a Samsung Galaxy A10e. Can you compare the Samsung Galaxy A10e with the Motorola Moto G7 Power?\nResponse: For the past few years, Motorola's G-series has consistently ranked as a favourite budget phone among users and the G7 continues this legacy as an exceptional phone for its price. All in all, people still love the Moto G7. It's a fantastic, affordable phone, and it won awards for its inexpensive price, good camera and reliable performance. But the Galaxy A50 is better, even if it's a bit more expensive. \n\n# Now, you should give me the rewrite of the **Current Question** for the following dialog. The output format should always be:\nRewrite: $Rewrite\nResponse: $Response."
        self.stop_tokens = None
    ...
    def build_turn_prompt(self, context, current_turn):
        ...
        this_prompt += "\n\n**Note that you should always try to rewrite it and generate a plausible answer. Never ask for clarification or say you don't understand it in the generated rewrite or the response.** Now, go ahead!"
        return this_prompt
...
class ZeroShotRewriteThenResponsePrompter:
    def __init__(self) -> None:    
        
        self.instruction = "Generate an appropriate response to the current question under the multi-turn information-seeking dialog context. The output format is: \nResponse: $Response"
        self.stop_tokens = None
